...
% This method computes the numerical gradient of a function
% and verifies if the analytical implementation is correct.
% when displaying both gradients, the difference should be significantly
% small
